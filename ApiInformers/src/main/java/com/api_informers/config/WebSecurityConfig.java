...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
            ...
            .antMatchers("/api/informador/edit").hasRole("INFORMER")
            .antMatchers("/api/informador/newFile").hasRole("INFORMER")
            .antMatchers("/api/informador/files").hasRole("INFORMER")
            .antMatchers("/api/informador/editFile").hasRole("INFORMER")
            .antMatchers("/api/informador/deleteFile").hasRole("INFORMER")
